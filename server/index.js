...
try{db.prepare("UPDATE countries SET logo='https://flagcdn.com/w80/'||lower(code)||'.png' WHERE COALESCE(trim(logo),'')='' AND code IS NOT NULL AND trim(code)<>''").run()}catch(e){console.error('Country flag logo seed:',e.message)}
